...
Swiftclaw is a collection of Riemann solvers that work together to simulate coastal hazards. Given a function and input data, swiftclaw produces numerical data that can be graphically presented.
